...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <img src="<?php echo validate_image($_settings->info('logo')) ?>" width="50" height="35" class="d-inline-block align-top" alt="" loading="lazy">
        <img src="<?php echo validate_image($_settings->info('short_name')) ?>" width="180" height="20" class="d-inline-block align-top" alt="" loading="lazy">
        </a>
        <!-- Sidebar -->
