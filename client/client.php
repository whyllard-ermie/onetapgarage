            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3" id="main2">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="try.php" method="post"  >
                            <!-- progressbar -->
                            <ul id="progressbar">
...
<input type="checkbox" id="service" name="s21"/><label id="servicelabel" for="service">PACKAGE SEVICE</label><input type="text" id="price" name="p1" />
                            ...
                            <fieldset>
                                ...
                                <input type="button" name="previous" class="previous action-button-previous" value="Previous"/>
                                <input type="button"  class="next action-button" name="make_payment"  value="Submit" data-toggle="modal" data-target="#reviewModal" />
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
...
<?php require_once "reviewmodal.php"; ?>
